...
Let us define an elliptic curve over the finite field $\mathbb{F}_{23}$. We choose $a = 1$ and $b = 4$ for our curve equation $y^2 = x^3 + x + 4$. First, we verify the curve is non-singular by checking the discriminant $\Delta$:
\[
